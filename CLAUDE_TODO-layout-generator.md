...
| T24 | impl3 | Re-run the PLAN's Verification on the tree after T23 (suite, wasm build, E2E), same protocol and artifacts as T22; report the wasm figure with T23 named, direction unknown, for re-pinning; report any other failure and wait. | T22, T23 | [x] |
